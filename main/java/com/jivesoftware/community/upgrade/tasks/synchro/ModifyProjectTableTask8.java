 ...
 */
public class ModifyProjectTableTask8 implements UpgradeTask {
    private static Logger LOG = Logger.getLogger(ModifyProjectTableTask8.class);
    private static String ADD_NEW_SYCNHRO_COLUMN = "ALTER TABLE grailproject ADD newsynchro integer ";
