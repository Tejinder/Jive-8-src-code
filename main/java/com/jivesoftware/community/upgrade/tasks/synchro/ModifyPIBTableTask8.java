 ...
 * @since: 1.0
 */
public class ModifyPIBTableTask8 implements UpgradeTask {
	
	private static final Logger LOGGER = Logger.getLogger(ModifyPIBTableTask8.class);
	
	private static String ADD_SEND_FOR_APPROVAL_DATE_COLUMN = "ALTER TABLE grailpib ADD sendforapprovaldate bigint ";
