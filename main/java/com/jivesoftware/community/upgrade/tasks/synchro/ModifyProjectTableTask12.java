 ...
 */
public class ModifyProjectTableTask12 implements UpgradeTask {
    private static Logger LOG = Logger.getLogger(ModifyProjectTableTask12.class);
    private static String ADD_GLOBAL_PROJECT_OUTCOME_COLUMN = "ALTER TABLE grailproject ADD globalOutcomeEUShare integer";
