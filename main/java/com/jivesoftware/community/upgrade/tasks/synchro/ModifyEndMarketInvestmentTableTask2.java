 ...
 * @since: 1.0
 */
public class ModifyEndMarketInvestmentTableTask2 implements UpgradeTask {
	
	private static final Logger LOGGER = Logger.getLogger(ModifyEndMarketInvestmentTableTask2.class);
	
	
	private static String ADD_FUNDING_MARKET_COLUMN = "ALTER TABLE grailendmarketinvestment ADD fundingMarket integer";
