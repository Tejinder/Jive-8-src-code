 ...
 */
public class ModifyProjectTableTask11 implements UpgradeTask {
    private static Logger LOG = Logger.getLogger(ModifyProjectTableTask11.class);
    private static String ADD_GLOBAL_PROJECT_OUTCOME_COLUMN = "ALTER TABLE grailproject ADD globalProjectOutcome integer";
    ...
    public void doTask() throws Exception {
        if (UpgradeUtils.doesTableExist("grailProject")) {
            try {
                UpgradeUtils.executeStatement(ADD_GLOBAL_PROJECT_OUTCOME_COLUMN);
