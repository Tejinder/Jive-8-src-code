 ...
 * @since: 1.0
 */
public class ModifyProposalTableTask7 implements UpgradeTask {
	
	private static final Logger LOGGER = Logger.getLogger(ModifyProposalTableTask7.class);
	

	
	private static String ADD_SEND_FOR_APPROVAL_DATE_COLUMN = "ALTER TABLE grailproposal ADD sendforapprovaldate bigint ";
    ...
    public void doTask() throws Exception {
        	...
        	if (UpgradeUtils.doesTableExist("grailproposal")) {
            	try{
            		UpgradeUtils.executeStatement(ADD_SEND_FOR_APPROVAL_DATE_COLUMN);
