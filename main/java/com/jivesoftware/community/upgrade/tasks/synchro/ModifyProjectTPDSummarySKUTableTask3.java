 ...
 */
public class ModifyProjectTPDSummarySKUTableTask3 implements UpgradeTask {
    private static Logger LOG = Logger.getLogger(ModifyProjectTPDSummarySKUTableTask3.class);
    
    private static String ADD_ROW_SAVE_COL = "ALTER TABLE grailprojecttpdskudetails ADD isrowsave integer;";
    ...
    public void doTask() throws Exception {
        if (UpgradeUtils.doesTableExist("grailprojecttpdskudetails")) {
            try {
                UpgradeUtils.executeStatement(ADD_ROW_SAVE_COL);
