 ...
 */
public class ModifyProjectTableTask14 implements UpgradeTask {
    private static Logger LOG = Logger.getLogger(ModifyProjectTableTask14.class);
    private static String ADD_ONLY_GLOBAL_TYPE_COLUMN = "ALTER TABLE grailproject ADD onlyglobaltype integer ";
    ...
    public void doTask() throws Exception {
        if (UpgradeUtils.doesTableExist("grailProject")) {
            try {
                UpgradeUtils.executeStatement(ADD_ONLY_GLOBAL_TYPE_COLUMN);
