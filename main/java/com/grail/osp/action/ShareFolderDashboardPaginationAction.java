...
@Decorate(false)
public class ShareFolderDashboardPaginationAction extends JiveActionSupport {

    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(ShareFolderDashboardPaginationAction.class);
    ...
    private List<OSPFolder> shareFolderList;
...
//        }
        ...
        setPagination(ospManager.getShareFoldersTotalCount(tileID).intValue());
        //setPagination(10);
        updatePage();
    ...
    public void updatePage() {
        ...
        shareFolderList = ospManager.getShareFolders(tileID,getSearchFilter());
    ...
    private ProjectResultFilter getSearchFilter() {
      ...
      /* if(projectResultFilter.getLimit() == null) {
        ...
        */
        ...
        // This is done to preserve the sort order.
        if(StringUtils.isNotBlank(projectResultFilter.getSortField()))
        {
        	//projectResultFilter.setSortField(sortBy);
        	sortBy = projectResultFilter.getSortField();
        }
        ...
        // This is done to preserve the sort order.
        if(projectResultFilter.getAscendingOrder()!=null && projectResultFilter.getAscendingOrder() == 1)
        {
        	sortOrder = projectResultFilter.getAscendingOrder();
        }
        if(sortOrder!=null && sortOrder == 1)
        {
        	projectResultFilter.setAscendingOrder(sortOrder);
	...
	public List<OSPFolder> getShareFolderList() {
		return shareFolderList;
	}

	public void setShareFolderList(List<OSPFolder> shareFolderList) {
		this.shareFolderList = shareFolderList;
	}
