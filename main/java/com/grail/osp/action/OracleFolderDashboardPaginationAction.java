...
@Decorate(false)
public class OracleFolderDashboardPaginationAction extends JiveActionSupport {

    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(OracleFolderDashboardPaginationAction.class);
...
//        }
        ...
        setPagination(ospManager.getOracleFoldersTotalCount(tileID).intValue());
        //setPagination(10);
        updatePage();
    ...
    public void updatePage() {
        ...
        oracleFolderList = ospManager.getOracleFolders(tileID,getSearchFilter());
