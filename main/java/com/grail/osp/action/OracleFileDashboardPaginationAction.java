...
@Decorate(false)
public class OracleFileDashboardPaginationAction extends JiveActionSupport {

    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(OracleFileDashboardPaginationAction.class);
...
//        }
        ...
        setPagination(ospManager.getOracleFilesTotalCount(tileID, folderID).intValue());
        //setPagination(10);
        updatePage();
    ...
    public void updatePage() {
        ...
        oracleFileList = ospManager.getOracleFiles(tileID,folderID, getSearchFilter());
