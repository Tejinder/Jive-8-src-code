...
public class ProjectSpecsDAOImpl extends JiveJdbcDaoSupport implements ProjectSpecsDAO {
    ...
    private static final String INSERT_PROJECT_SPECS_SQL = "INSERT INTO grailprojectspecs( " +
            ...
            " projectdesc, ponumber,ponumber1, abovemarketfinalcost, abovemarketfinalcosttype, categorytype, pslegalapprovaldate) " +
            " VALUES (?, ?, ?, " +
            " ?, ?, ?, " +
            " ?, ?, ?, ?,  " +
            " ?, ?, ?, ?, ?, " +
    ...
    public ProjectSpecsInitiation save(final ProjectSpecsInitiation projectSpecsInitiation) {
        try {
            getSimpleJdbcTemplate().update(INSERT_PROJECT_SPECS_SQL, projectSpecsInitiation.getProjectID(), projectSpecsInitiation.getEndMarketID(),
            		...
            		projectSpecsInitiation.getBrand(), projectSpecsInitiation.getProjectOwner(), projectSpecsInitiation.getSpiContact(),
            		...
            		projectSpecsInitiation.getMethodologyType(),projectSpecsInitiation.getMethodologyGroup(), projectSpecsInitiation.getStatus(),
            ...
            final String message = "Failed to SAVE Project Specs Details for projectID" + projectSpecsInitiation.getProjectID() +" and End Market Id -"+ projectSpecsInitiation.getEndMarketID();
            LOG.log(Level.SEVERE, message, daEx);
            throw new DAOException(message, daEx);
        }
