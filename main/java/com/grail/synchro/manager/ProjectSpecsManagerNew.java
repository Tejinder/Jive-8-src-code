 ...
 * @since: 1.0
 */
public interface ProjectSpecsManagerNew {
    ...
    void deleteAllProjectSpecsDetails(final Long projectID);
    void deleteProjectSpecsDetails(final Long projectID, final Long endMarketID);
    List<ProjectSpecsInitiation> getProjectSpecsInitiationNew(final Long projectID);
    ProjectSpecsInitiation updateProjectSpecsDetailsNew(final ProjectSpecsInitiation projectSpecsInitiation);
    void resetProjectSpecs(final ProjectSpecsInitiation projectSpecsInitiation);
}
