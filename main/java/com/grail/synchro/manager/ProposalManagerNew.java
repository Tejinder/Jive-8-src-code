 ...
 * @since: 1.0
 */
public interface ProposalManagerNew {
    ...
    void removeAllAgency(final Long projectId);
    ...
    List<ProposalInitiation> getProposalInitiationNew(final Long projectID);
    ProposalInitiation updateProposalDetailsNew(final ProposalInitiation proposalInitiation);
    void updateProposalSendForApproval(final ProposalInitiation proposalInitiation);
    void updateProposalNeedsDiscussion(final ProposalInitiation proposalInitiation);
    void confirmLegalApprovalSubmission(final ProposalInitiation proposalInitiation);
    public List<ProposalInitiation> getProposalPendingActivities(ProjectResultFilter projectFilter);
    void updateProposalSendForReminder(final ProposalInitiation proposalInitiation);
    
    void resetProposal(final ProposalInitiation proposalInitiation);
}
