 ...
 */
public interface ProjectManagerNew {
    ...
    void saveProjectCoseDetails(List<ProjectCostDetailsBean> projectCostDetails, BigDecimal totalCost);
    
    void saveProjectCostDetails(List<ProjectCostDetailsBean> projectCostDetails);
    
    List<ProjectCostDetailsBean> getProjectCostDetails(final Long projectId);
    void deleteProjectCostDetails(final Long projectID);
    void updateProjectMW(Project project);
    ...
    Map<Integer, BigDecimal> getTotalCosts(List<ProjectCostDetailsBean> projectCostDetails, BigDecimal totalCostGBP);
