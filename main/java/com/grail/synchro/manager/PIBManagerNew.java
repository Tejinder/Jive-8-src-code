 ...
 * @since: 1.0
 */
public interface PIBManagerNew {

    List<ProjectInitiation> getPIBDetails(final long projectID);
    List<ProjectInitiation> getPIBDetailsNew(final Long projectID);
    ...
    ProjectInitiation updatePIBDetailsNew(final ProjectInitiation projectInitiation);
    ...
    boolean addAttachment(InputStream attachment,String fileName, final String contentType, Long projectId, Long endMarketId, Long fieldType, Long userId);
