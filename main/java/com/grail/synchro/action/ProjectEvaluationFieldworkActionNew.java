 ...
 */
public class ProjectEvaluationFieldworkActionNew extends JiveActionSupport implements Preparable {

    private static final Logger LOG = Logger.getLogger(ProjectEvaluationFieldworkActionNew.class);
    //Spring Managers
    	...
    	if (SynchroPermHelper.hasProjectAccessNew1(projectID) ||  SynchroPermHelper.userTypeAccess(projectID)) {
    		...
    		// Only System Admin can access the Cancel Projects
         	if(project.getIsCancel())
         	{
           	...
           	if(redirectURL.contains("project-eval-fieldwork"))
               {
               	return INPUT;
               }
               else
    ...
    public String execute(){
      ...
      //  if( projectInitiation != null && ribDocument != null){
        ...
        if(getRequest().getParameter("confirmProject")!=null && !getRequest().getParameter("confirmProject").equalsIgnoreCase(""))
        {
        	...
        	return "project-close-fieldwork";
        }
