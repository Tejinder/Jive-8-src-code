 ...
 */
public class RegionalOpenDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(RegionalOpenDashboardAction.class);
