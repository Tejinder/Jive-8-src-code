 ...
 */
public class EndMarketCloseDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(EndMarketCloseDashboardAction.class);
