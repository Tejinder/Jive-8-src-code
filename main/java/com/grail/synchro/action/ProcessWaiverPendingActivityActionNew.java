 ...
 */
public class ProcessWaiverPendingActivityActionNew extends JiveActionSupport {
    private static final Logger LOGGER = Logger.getLogger(ProcessWaiverPendingActivityActionNew.class);
    private PermissionManager permissionManager;
    
    private boolean pendingProcessWaiverCatalogue = true;

    public boolean isPendingProcessWaiverCatalogue() {
        return pendingProcessWaiverCatalogue;
    }
