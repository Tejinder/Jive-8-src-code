...
@Decorate(false)
public class ProjectSummaryPaginationReportAction extends JiveActionSupport{ 
	
	private static final long serialVersionUID = 1L;
	private static final Logger LOGGER = Logger.getLogger(ProjectSummaryPaginationReportAction.class);
