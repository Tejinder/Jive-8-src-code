 ...
 */
public class EndMarketOpenDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(EndMarketOpenDashboardAction.class);
