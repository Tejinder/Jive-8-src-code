...
public class ProjectWaiverCatalogueActionNew extends JiveActionSupport {

    private PermissionManager permissionManager;
    private boolean waiverCatalogue = true;
	...
	public boolean isWaiverCatalogue() {
		return waiverCatalogue;
	}
    @Override
