 ...
 * @version 1.0, 
 */
public class ProjectCurrentStatusDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(ProjectCurrentStatusDashboardAction.class);
