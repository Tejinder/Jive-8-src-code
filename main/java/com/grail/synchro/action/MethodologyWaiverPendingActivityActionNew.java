...
public class MethodologyWaiverPendingActivityActionNew extends JiveActionSupport {

    private PermissionManager permissionManager;
    private boolean pendingMethWaiverCatalogue = true;
    private boolean initiateWaiver = false;
    
    public boolean isPendingMethWaiverCatalogue() {
		return pendingMethWaiverCatalogue;
	}
