 ...
 * @version 1.0, 
 */
public class ProjectHistoryAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(ProjectHistoryAction.class);
    private PermissionManager permissionManager;
    
    private boolean historyCatalogue = true;
    
 	public boolean isHistoryCatalogue() {
		return historyCatalogue;
	}
