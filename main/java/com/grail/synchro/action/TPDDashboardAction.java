...
/**
 * @author Tejinder
 * @version 1.0, Date: 29/11/16
 */
public class TPDDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(TPDDashboardAction.class);
    ...
    private boolean tpdDashboard = true;
...
//    	}
	...
	public boolean isTpdDashboard() {
		return tpdDashboard;
	}
	public void setTpdDashboard(boolean tpdDashboard) {
		this.tpdDashboard = tpdDashboard;
	}
}
