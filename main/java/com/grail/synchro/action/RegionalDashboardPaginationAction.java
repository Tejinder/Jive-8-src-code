...
@Decorate(false)
public class RegionalDashboardPaginationAction extends JiveActionSupport{

    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(RegionalDashboardPaginationAction.class);
...
//        }
    ...
    {
    	downloadFilename = "RegionalAllProjectsDashboard.xls";
        ...
        try
        {
        	...
        	if(downloadReportType!=null && downloadReportType.equals("ProjectSummary"))
        	{
                ...
                SynchroLogUtils.addLog(SynchroGlobal.PortalType.SYNCHRO.getDescription(), SynchroGlobal.PageType.REPORTS.getId(), SynchroGlobal.Activity.DOWNLOAD.getId(), 
        				0, "Regional All Projects Summary - Download Report", "", -1L, getUser().getID());
        	}
        	else
        	{
        		processReport();
        		//Audit Logs
                SynchroLogUtils.addLog(SynchroGlobal.PortalType.SYNCHRO.getDescription(), SynchroGlobal.PageType.REPORTS.getId(), SynchroGlobal.Activity.DOWNLOAD.getId(), 
        				0, "Regional All Projects Status - Download Report", "", -1L, getUser().getID());
        	}
        }
    ...
    private void processRawExtactReport() throws IOException {
        HSSFWorkbook workbook = null;
        workbook = new HSSFWorkbook();
        downloadFilename = "RegionalAllProjectsSummary.xls";
       ...
       generatedBy.append("Regional All Projects Report ").append("\n");
       ...
       if(projects!=null && projects.size()>0)
       {
        ...
        workbook = SynchroRawExtractUtil.generateRawExtract(workbook,generatedBy.toString(),"RegionalAllProjects", projectIds);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        workbook.write(baos);
        downloadStream = new ByteArrayInputStream(baos.toByteArray());
    ...
    private HSSFWorkbook generateReport(HSSFWorkbook workbook) throws UnsupportedEncodingException, IOException{
        ...
        StringBuilder generatedBy = new StringBuilder();
        generatedBy.append("Regional Projects Report ").append("\n");
        ...
        generatedBy.append("\"").append("Filters:").append(Joiner.on(" | ").join(selectedFilters)).append("\"").append("\n");
         ...
         Integer startRow = 4;
         HSSFSheet sheet = workbook.createSheet("RegionalAllProjectsDashboard");
...
//        }
        ...
        // Cancel Projects should be accessible to Admin users and Synchro System Owner only 
