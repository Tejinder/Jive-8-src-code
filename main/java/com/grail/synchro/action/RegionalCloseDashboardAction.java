 ...
 */
public class RegionalCloseDashboardAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(RegionalCloseDashboardAction.class);
