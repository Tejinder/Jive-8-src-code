...
/**
 * @author Tejinder
 * @version 1.0, Date: 11/12/14
 */
public class DelegateAddStakeholdersAction extends JiveActionSupport {

    private static final Logger LOGGER = Logger.getLogger(DelegateAddStakeholdersAction.class);
...
//    	}
    	...
    	if (SynchroPermHelper.isExternalAgencyUser() || SynchroPermHelper.isLegalUser()) {
             return UNAUTHORIZED;
         }
