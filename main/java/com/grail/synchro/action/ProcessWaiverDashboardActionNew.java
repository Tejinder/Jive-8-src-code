...
public class ProcessWaiverDashboardActionNew extends JiveActionSupport {

    private PermissionManager permissionManager;
    private boolean processWaiverCatalogue = true;
	...
	public boolean isProcessWaiverCatalogue() {
		return processWaiverCatalogue;
	}
    @Override
