 ...
 */
public class GrailAttachmentEntitlementCheckProvider
        extends BaseEntitlementProvider<GrailAttachment> implements EntitlementCheckProvider<GrailAttachment> {
    @Override
    ...
    @Override
    public boolean isUserEntitled(User user, GrailAttachment object, EntitlementTypeProvider.Type type) {
    ...
    public boolean isUserEntitled(GrailAttachment object, User user) {
