...
<% // Title of this page and breadcrumbs
    String title = "Kantar Button Methodology Types";
...
<head>
    ...
    <content tag="pageID">kantar-button-methodology-types</content>
    <content tag="pagehelp">
        <h3>Kantar Button Methodology Types</h3>
    </content>
</head>

<div>
    <form action="kantar-button-methodology-types.jsp" name="synchro-metaform" id="synchro-metaform" method="post">
                        ...
                        <ul class="jstree">
                            <li id="space_1" class="">
                                ...
                                <ul id="space_1_ul" class="ui-sortable" style="display: block;">
                                    ...
                                    <%
                                        Map<Long, String> methodologyTypes = KantarUtils.getKantarButtomMethodologyTypes();
...
<script type="text/javascript">
    ...
    function deleteProperty(id) {
        ...
        if (res == true) {
            MetaFieldUtil.deleteKantarButtonMethodologyType(id, {
    ...
    function updateSortOrder()  {
        ...
        MetaFieldUtil.sortKantarButtonMethodologyTypes(orderMap, {
            callback: function(result) {
                $j("#synchro-metaform").submit();
            },
            async: false,
    ...
    $j(".save").click(function(){
        ...
        {
            MetaFieldUtil.updateKantarButtonMethodologyType(id, input.val(), {
                callback: function(result) {
                    $j("#synchro-metaform").submit();
                },
                async: false,
    ...
    $j(document).ready(function () {
        ...
        $j("#add-btn").click(function(){
            ...
            if(input.val()!=null && $j.trim(input.val())!="" && input.val().length < 250)
            {
                ...
                MetaFieldUtil.addKantarButtonMethodologyType(input.val(),{
                    callback: function(result) {
                        $j("#synchro-metaform").submit();
                    },
                    async: false,
