...
<%@ page import="com.grail.kantar.beans.KantarBriefTemplate" %>
<%@ page import="com.grail.kantar.manager.KantarBriefTemplateManager" %>
<%@ page import="com.grail.kantar.util.KantarGlobals" %>
...
<% // Title of this page and breadcrumbs
    String title = "Kantar Brief Templates Raw Extract";
    ...
    if(request.getParameter("downloadReport") != null && Boolean.parseBoolean(request.getParameter("downloadReport"))) {
        ...
        KantarBriefTemplateManager kantarBriefTemplateManager = JiveApplication.getContext().getSpringBean("kantarBriefTemplateManager");
        List<KantarBriefTemplate> kantarBriefTemplates = kantarBriefTemplateManager.getAll();
        if(kantarBriefTemplates != null && kantarBriefTemplates.size() > 0) {
            for(KantarBriefTemplate template: kantarBriefTemplates) {
                Map<String, Object> templateMap = KantarGlobals.toKantarBriefTemplateMap(template, template.getSender());
        ...
        response.setHeader("content-disposition","filename=KantarBriefTemplatesRawExtract.csv"); // Filename
...
<head>
    ...
    <content tag="pageID">kantarBriefTemplatesRawExtract</content>
    <content tag="pagehelp">
        <h3>Kantar Brief Templates Raw Extract</h3>
    </content>
</head>

<div>
    <form action="kantar-brief-templates-raw-extract.jsp" method="post">
